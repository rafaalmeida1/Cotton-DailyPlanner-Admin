            ...
            <form className="mb-5">
              ...
              {/* <div className="w-full md:w-1/2 px-3">
                  ...
                  <input
                    ...
                    placeholder="Sextou"
                    // value={searchWeekDay}
                    // onChange={(e) => setSearchWeekDay(e.target.value.toUpperCase())}
                    />
                    </div>
                    </div>
                ...
                <div className="w-full md:w-1/2 px-3">
                  ...
                  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-1 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="data"
                    type="text"
                    placeholder="mudar data"
                    />
                </div>
                <div className="w-full md:w-1/2 px-3">
                  <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="horas">
                  Até que horas
                  </label>
                  <input
                  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-1 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                  ...
                  {sales.map((sale, index) =>
                    searchStore == sale.loja && (
                      <tr key={index} className="bg-gray-50 border border-white">
                        ...
                        <td className="whitespace-nowrap p-3 text-sm text-green-500">R$ <span className="text-gray-700 font-bold">{sale.salesPerHour}</span></td>
                        ...
                        <td className="whitespace-nowrap p-3 text-sm text-gray-700 font-bold">{sale.foundation}</td>
